...
namespace Figgle.Generator
{
    ...
    public sealed class FiggleSourceGenerator : ISourceGenerator
    {
        ...
        public const string AttributeSource = @"// Copyright Drew Noakes. Licensed under the Apache-2.0 license. See the LICENSE file for more details.
...
");
                    ...
                    sb.Append($@"    partial class {type.Class}
    {{
");
                    ...
                    foreach (var item in data.Items)
                    {
                        ...
                        sb.Append($@"        public static string {item.MemberName} {{ get; }} = @""{text.Replace("\"", "\"\"")}"";
");
                    }
